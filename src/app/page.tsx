...
export default async function ClientBookingPage() {
  ...
  return (
    <main className="min-h-screen bg-gray-100 p-4 sm:p-8 font-body">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-10">
          <h1 className="text-5xl font-bold text-gray-900 font-headline">BarberFlow</h1>
          <p className="text-gray-600 mt-2">Agende um Horário com os Melhores Barbeiros</p>
        </div>
